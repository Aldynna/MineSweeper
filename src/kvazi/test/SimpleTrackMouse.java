...
public class SimpleTrackMouse extends JPanel {
	...
	private String eventType = null; // If non-null, gives the type of the most
										// recent mouse event.
	private String modifierKeys = ""; // If non-empty, gives special keys that
										// are held down.
	private String button = ""; // Information about which mouse button was
								// used.
	private int mouseX, mouseY; // Position of mouse (at most recent mouse
								// event).
	...
	public SimpleTrackMouse() {
		// Set background color and arrange for the panel to listen for mouse
		// events.
	 ...
	 * 
	 * @param evt
	 *            the MouseEvent object for the event.
	 * @param eventType
	 *            a description of the type of event, such as "mousePressed".
	 */
	...
	/**
	 * An object belonging to class MouseHandler listens for mouse events on the
	 * panel. (Listening is set up in the constructor for the
	 * SimpleTrackMousePanel class.) When a mouse event occurs, the listener
	 * simply calls the setInfo() method in the SimpleMouseTrackPanel class with
	 * information about the mouse event that has occurred.
	 */
